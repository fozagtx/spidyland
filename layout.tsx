...
export const metadata = {
  ...
  title: "Eternal USDC | Premium Digital Legacy Protection",
  description: "The premier decentralized inheritance platform for discerning individuals. Secure your digital wealth with institutional-grade smart contracts.",
};
...
export default async function RootLayout({
  ...
  return (
    <html lang="en" className={GeistSans.className} suppressHydrationWarning>
      <body className="bg-background text-foreground premium-text antialiased">
        <ThemeProvider
          attribute="class"
          defaultTheme="dark"
          enableSystem
